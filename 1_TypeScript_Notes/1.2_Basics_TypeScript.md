...
This is not valid TypeScript Syntax, although if you're using tsc to compile this. It'll still work.

*Necessarily* this is still valid JavaScript code, But TypeScript will be sure to notify you
```ruby
